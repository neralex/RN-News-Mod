...
$elLanguage = array (
			...
			'errWrite'             => '无法写入 %s.',
			'errPerm'              => '无权限.',
			'errLocked'            => '%s 被锁定,不能重命名, 移动或删除.',
			'errExists'            => '文件 %s 已经存在了.',
			'errInvName'           => '无效的文件名.',
			'errFolderNotFound'    => '未找到文件夹.',
			'errFileNotFound'      => '未找到文件.',
			'errTrgFolderNotFound' => '未找到目标文件夹 %s.',
			'errPopup'             => '浏览器拦截了弹出窗口. 请在选项中允许弹出窗口.',
			'errMkdir'             => '不能创建文件夹 %s.',
			'errMkfile'            => '不能创建文件 %s.',
			'errRename'            => '不能重命名 %s.',
			'errCopyFrom'          => '不允许从卷 %s 复制.',
			'errCopyTo'            => '不允许向卷 %s 复制.',
			...
			'errUploadTransfer'    => '%s 传输错误.',
			'errSave'              => '无法保存 %s.',
			'errCopy'              => '无法复制 %s.',
			'errMove'              => '无法移动 %s.',
			'errCopyInItself'      => '不能移动 %s 到原有位置.',
			'errRm'                => '无法删除 %s.',
			'errExtract'           => '无法从 %s 提取文件.',
			'errArchive'           => '无法创建压缩包.',
			'errArcType'           => '不支持的压缩格式.',
