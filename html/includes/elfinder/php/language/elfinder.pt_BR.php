 ...
 * Leandro Carvalho <contato@leandrowebdev.net>
 */
...
$elLanguage = array (
			...
			'errCmdParams'         => 'Parâmetro inválido para o comando %s.',
			...
			'errOpen'              => 'Incapaz de abrir %s.',
			'errNotFolder'         => 'Objeto não é uma pasta.',
			'errNotFile'           => 'Objeto não é um arquivo.',
			'errRead'              => 'Incapaz de ler %s.',
			'errWrite'             => 'Incapaz de escrever em %s.',
			'errPerm'              => 'Permissão negada.',
			'errLocked'            => '%s está bloqueado e não pode ser renomeado, movido ou removido.',
			'errExists'            => 'O nome do arquivo %s já existe neste local.',
			'errInvName'           => 'Nome do arquivo inválido.',
			'errFolderNotFound'    => 'Pasta não encontrada.',
			'errFileNotFound'      => 'Arquivo não encontrado.',
			'errTrgFolderNotFound' => 'Pasta de destino %s não encontrada.',
			'errPopup'             => 'Navegador impediu abertura da janela popup, Para abrir o arquivo desabilite está  opção no navegador.',
			'errMkdir'             => 'Incapaz de criar a pasta %s.',
			'errMkfile'            => 'Incapaz de criar o arquivo %s.',
			'errRename'            => 'Incapaz de renomear %s.',
			'errCopyFrom'          => 'Copia dos arquivos do volume %s não permitida.',
			'errCopyTo'            => 'Copia dos arquivos para o volume %s não permitida.',
			'errUploadCommon'      => 'Erro no upload.',
			'errUpload'            => 'Incapaz de fazer o upload de %s.',
			...
			'errUploadTransfer'    => '%s erro na transferência.',
			'errSave'              => 'Incapaz de salvar %s.',
			'errCopy'              => 'Incapaz de copiar %s.',
			'errMove'              => 'Incapaz de mover %s.',
			'errCopyInItself'      => 'Incapaz de copiar %s nele mesmo.',
			'errRm'                => 'Incapaz de remover %s.',
			'errExtract'           => 'Incapaz de extrair os arquivos de %s.',
