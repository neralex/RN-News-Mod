...
$elLanguage = array (
			...
			'errCmdParams'         => 'Некорректные параметры комманды %s.',
			...
			'errOpen'              => 'Не удалось открыть %s.',
			'errNotFolder'         => 'Объект не является папкой.',
			'errNotFile'           => 'Объект не является файлом.',
			'errRead'              => 'Ошибка чтения %s.',
			'errWrite'             => 'Ошибка записи %s.',
			'errPerm'              => 'Доступ запрещен.',
			'errLocked'            => '%s защищен и не может быть переименован, перемещен или удален.',
			'errExists'            => 'В папке уже существует объект с именем %s.',
			'errInvName'           => 'Недопустимое имя файла.',
			'errFolderNotFound'    => 'Папка не найдена.',
			'errFileNotFound'      => 'Файл не найден.',
			'errTrgFolderNotFound' => 'Целевая папка %s не найдена.',
			'errPopup'             => 'Браузер заблокировал открытие нового окна. Чтобы окрыть файл, измените настройки браузера.',
			'errMkdir'             => 'Ошибка создания папки %s.',
			'errMkfile'            => 'Ошибка создания файла %s.',
			'errRename'            => 'Ошибка переименования %s.',
			'errCopyFrom'          => 'Копирование из корневой директории %s запрещено.',
			'errCopyTo'            => 'Копирование в корневую директорию %s запрещено.',
			'errUploadCommon'      => 'Ошибка загрузки файлов.',
			'errUpload'            => 'Ошибка загрузки %s.',
			...
			'errUploadTransfer'    => 'Ошибка передачи файла %s.',
			'errSave'              => 'Ошибка сохранения %s.',
			'errCopy'              => 'Ошибка копирования %s.',
			'errMove'              => 'Ошибка перемещения %s.',
			'errCopyInItself'      => 'Невозможно скопировать %s в самого себя.',
			'errRm'                => 'Ошибка удаления %s.',
			'errExtract'           => 'Ошибка извлечения файлов из архива %s.',
			...
			'errReplByChild'       => 'Невозможно заменить папку %s содержащимся в ней объектом.',
			...
			'errResize'            => 'Не удалось изменить размер %s.',
