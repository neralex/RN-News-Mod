...
/*
 * German translation
 * JPG & Mace <dev@flying-datacenter.de>
 */
...
$elLanguage = array (
			...
			'errMkdir'             => 'Kann Verzeichnis %s nicht erstellen.',
			'errMkfile'            => 'Kann Datei %s nicht erstellen.',
			'errRename'            => 'Kann %s nicht umbenennen.',
			'errCopyFrom'          => 'Kopieren von Dateien von %s nicht erlaubt.',
			'errCopyTo'            => 'Kopieren von Dateien nach %s nicht erlaubt.',
			'errUploadCommon'      => 'Upload Fehler.',
			'errUpload'            => 'Kann %s nicht hochladen.',
			...
			'errUploadTransfer'    => '%s Transfer Fehler.',
			'errSave'              => 'Kann %s nicht speichern.',
			'errCopy'              => 'Kann %s nicht kopieren.',
			'errMove'              => 'Kann %s nicht verschieben.',
			'errCopyInItself'      => '%s kann sich nicht in sich selbst kopieren.',
			'errRm'                => 'Kann %s nicht enfernen.',
			'errExtract'           => 'Kann %s nicht entpacken .',
