...
/*
 * French translation
 * Régis Guyomarch <regisg@gmail.com>
 */
...
$elLanguage = array (
			...
			'errCmdParams'         => 'Mauvais Paramétrage de la commande %s.',
			...
			'errOpen'              => 'Impossible d\'ouvrir %s.',
			'errNotFolder'         => 'Cet objet n\'est pas un dossier.',
			'errNotFile'           => 'Cet objet n\'est pas un fichier.',
			'errRead'              => 'Impossible de lire %s.',
			'errWrite'             => 'Impossible d\'écrire dans %s.',
			'errPerm'              => 'Permission refusée.',
			'errLocked'            => '%s est verrouillé et ne peut être déplace ou supprimé.',
			'errExists'            => 'Un fichier nommé %s existe déjà.',
			'errInvName'           => 'Nom de fichier incorrect.',
			'errFolderNotFound'    => 'Dossier non trouvé.',
			'errFileNotFound'      => 'Fichier non trouvé.',
			'errTrgFolderNotFound' => 'Dossier destination %s non trouvé.',
			...
			'errMkdir'             => 'Impossible de créer le dossier %s.',
			'errMkfile'            => 'impossible de créer le fichier %s.',
			'errRename'            => 'Impossible de renommer %s.',
			'errCopyFrom'          => 'Interdiction de copier des fichiers depuis le volume %s.',
			'errCopyTo'            => 'Interdiction copier des fichiers vers le volume %s.',
			'errUploadCommon'      => 'Erreur lors de l\'envoi du fichier.',
			'errUpload'            => 'Impossible d\'envoyer %s.',
			...
			'errUploadTransfer'    => '%s erreur transfert.',
			'errSave'              => 'Impossible de sauvegarder %s.',
			'errCopy'              => 'Impossible de copier %s.',
			'errMove'              => 'Impossible de déplacer %s.',
			'errCopyInItself'      => 'Impossible de copier %s sur lui-même.',
			'errRm'                => 'Impossible de supprimer %s.',
			'errExtract'           => 'Impossible d\'extraire les fichier de %s.',
