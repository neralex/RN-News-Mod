 ...
 * Tawfek Daghistani <tawfekov@gmail.com>
 */
...
$elLanguage = array (
			...
			'errCmdParams'         => 'البيانات المرسلة للأمر غير مقبولة %s.',
			...
			'errOpen'              => 'غير قادر على فتح  %s.',
			'errNotFolder'         => 'العنصر المختار ليس مجلد',
			'errNotFile'           => 'العنصر المختار ليس ملف',
			'errRead'              => 'غير قادر على القراءة %s.',
			'errWrite'             => 'غير قادر على الكتابة %s.',
			'errPerm'              => 'وصول مرفوض ',
			'errLocked'            => ' محمي و لا يمكن التعديل أو النقل أو إعادة التسمية%s',
			'errExists'            => ' موجود مسبقاً %s',
			'errInvName'           => 'الاسم مرفوض',
			'errFolderNotFound'    => 'المجلد غير موجود',
			'errFileNotFound'      => 'الملف غير موجود',
			'errTrgFolderNotFound' => 'الملف الهدف  %s غير موجود ',
			'errPopup'             => 'يمنعني المتصفح من إنشاء نافذة منبثقة , الرجاء تعديل الخيارات الخاصة  من إعدادات المتصفح ',
			'errMkdir'             => ' غير قادر على إنشاء مجلد جديد %s.',
			'errMkfile'            => ' غير قادر على إنشاء ملف جديد%s.',
			'errRename'            => 'غير قادر على إعادة تسمية ال  %s.',
			'errCopyFrom'          => 'نسخ الملفات من الوسط المحدد %sغير مسموح.',
			'errCopyTo'            => 'نسخ الملفات إلى الوسط المحدد %s غير مسموح .',
			'errUploadCommon'      => 'خطأ أثناء عملية الرفع',
			'errUpload'            => 'غير قادر على رفع %s.',
			...
			'errUploadTransfer'    => '%s خطأ أثناء عملية النقل',
			'errSave'              => 'غير قادر على الحفظ في  %s.',
			'errCopy'              => 'غير قادر على النسخ إلى%s.',
			'errMove'              => 'غير قادر على القص إلى %s.',
			'errCopyInItself'      => 'غير قادر على نسخ الملف %s ضمن الملف نفسه.',
			'errRm'                => 'غير قادر على الحذف %s.',
			'errExtract'           => 'غير قادر على استخراج الملفات من  %s.',
