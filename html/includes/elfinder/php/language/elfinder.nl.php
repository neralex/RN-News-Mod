...
/*
 * Dutch translation
 * Barry vd. Heuvel <barry@fruitcakestudio.nl>
 */
...
$elLanguage = array (
			...
			'errMkdir'             => 'Kan map %s niet aanmaken.',
			'errMkfile'            => 'Kan bestand %s niet aanmaken.',
			'errRename'            => 'Kan %s niet hernoemen.',
			'errCopyFrom'          => 'Bestanden kopiëren van %s is niet toegestaan.',
			'errCopyTo'            => 'Bestanden kopiëren naar %s is niet toegestaan.',
			'errUploadCommon'      => 'Upload fout.',
			'errUpload'            => 'Kan %s niet uploaden.',
			...
			'errUploadTransfer'    => '%s overdrachtsfout.',
			'errSave'              => 'Kan %s niet opslaan.',
			'errCopy'              => 'Kan %s niet kopiëren.',
			'errMove'              => 'Kan %s niet verplaatsen.',
			'errCopyInItself'      => 'Kan %s niet in zichzelf kopiëren.',
			'errRm'                => 'Kan %s niet verwijderen.',
			'errExtract'           => 'Kan de bestanden van %s niet uitpakken.',
			...
			'errReplByChild'       => 'De map %s kan niet vervangen worden door een item uit die map.',
			...
			'errResize'            => 'Kan het formaat van %s niet wijzigen.',
