...
/**************************************************************************/
//if(!defined('_ADD')) define('_ADD','Hinzuf&uuml;gen');
...
define('_ANNOYINGMSG','Nach meinen Unterlagen sind die Themen, auf die Sie versuchen zu antworten, nicht vorhanden. Schlecht, wenn Sie versuchen, l&auml;stig zu sein.');
...
define('_HASSENTERROR','Aufgrund eines Mailer Fehlers wurde der Artikel nicht gesendet. Bitte kontaktieren Sie  den Websiteadmin.');
...
define('_READWITHCOMMENTS', 'Den kompletten Artikel mit seinen Kommentare lesen von');
...
define('_SOMETHINGSNOTRIGHT','Irgendetwas ist nicht richtig. Diese Nachricht erscheint nur, um Folgefehler einzugrenzen');
...
define('_TONRELATED','Verwandte');
define('_TONRATETHIS','Dies bewerten');
define('_TONSHARE','Teilen');
if (!defined('_TONPOSTTIME')) define('_TONPOSTTIME','Posting-Time');
if (!defined('_TONAUTHOR')) define('_TONAUTHOR','Author');
if (!defined('_TONREADS')) define('_TONREADS','Gelesen');