 ...
 */
define('_ACTIVATECOMMENTS','Aktivera kommentarer för den här artikeln?');
define('_ADDARTICLE','Lägg till ny artikel');
define('_ALLSTORIES','Alla artiklar under');
define('_ANDCOMMENTS','och alla kommentarer?');
define('_ARESUREURL','(Om du inkluderar webadresser var noga med att kolla så att dom fungerar.)');
if (!defined('_AREYOUSURE')) define('_AREYOUSURE','Om du inkluderar webadresser var noga med att kolla så att dom fungerar + att titta efter stavfel etc?');
define('_ARTICLEADMIN','Artikel/nyhets Administrationen');
define('_ASELECTCATEGORY','Välj kategori');
define('_ATTACHAPOLL','Lägg till en omröstning för den här artikeln');
...
define('_CATEGORYADD','Lägg till ny kategori');
define('_CATEGORYNAME','Kategori namn');
define('_CATEXISTS','Den här kategorien finns redan!');
define('_CATNAME','Kategori Namn');
define('_CATSAVED','Kategori sparad!');
define('_CHNGPROGRAMSTORY','Välj nytt datum för den här artikeln:');
...
define('_APPROVEARTICLE','Godkänna artikel');
define('_EMAILUSER','Email Användare');
define('_EXTENDEDTEXT','Utökad text');
define('_GOTOADMIN','Gå till admin sektionen')
;define('_HAS','har');
define('_LEAVEBLANKTONOTATTACH','(Lämnas blank för att posta artikel utan omröstning)<br />(OBS: Programerade artiklar kan inte ha omröstning)');
